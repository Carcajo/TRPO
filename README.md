...
- Производительность: время анализа одного текста не должно превышать 20 секунд.
- Надёжность: высокая стабильность работы сервиса, не более 1% ошибок при запросах.
